        ...
        <Row>
          ...
          <Col lg="6" md="6">
            <div className="app_content">
              ...
              <h2 className="mb-4">
                Never Feel Hungry! Download Our Mobile App & Order Delicious
                Food
              </h2>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Doloremque quae soluta culpa dolores molestias repellat vitae
                quod illo, ad exercitationem.
              </p>
              ...
              <div className="app_btns d-flex align-items-center gap-5 mt-4">
                ...
                <button className="btn_google d-flex align-items-center gap-3">
                  <i class="ri-google-line"></i> <a href="#">Google Play</a>
                </button>
              </div>
            </div>
          </Col>
